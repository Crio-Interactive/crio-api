...
const { Peer, Port, SecurityGroup, GatewayVpcEndpointAwsService, Vpc } = require('@aws-cdk/aws-ec2');
...
class VpcStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    this.ingressSecurityGroup = new SecurityGroup(this, Utils.prefixByAppName('ingress-security-group'), {
      vpc: this.vpc,
